...
download_azurlane () {
    ...
    if [ "$bundle_id" = "com.bilibili.azurlane" ]; then
        ...
        # 直接下载到正确的文件名
        wget --no-check-certificate --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36" "$cn_download_url" -O "${bundle_id}.apk"
